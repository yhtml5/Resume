...
- 24岁丨本科丨两年开发经验丨18758302302丨1417376255@qq.com  
- 目前所在城市：杭州市  
- 期望工作地点：杭州主城区  
...
## 自我介绍  
我热爱计算机、互联网技术，具有较强的框架思维和模仿创新能力。
喜欢学习研究最新的Web技术并动手操作在自己的网站、APP等作品中实现这个新功能。
读十本书不如亲自做一个网站，为了将自己所学的能得到应用，也同时可以记录自己学习研究、技术开发中心得感想，于是做了一个[技术综合型网站],(目前用angular重构中,您可以随时关注项目进程)  


## 我的优势
* 能根据项目特点,产品需求进行前端技术选型.能独立完成一套前端项目.包括页面UI组件开发,前后端数据通讯. 能带前端团队
* 有自己一套前端开发工作流[YHTML5-Seed](类似yeoman),基于NodeJs+Npm+Bower+Fis3 目前已在github上开源.
* 俩套基于[YHTML5-Seed]工作流的技术栈:  
    1. Angular + Angular-UI-Router + Angular-Bootstrap + Angular Plugins...
    2. JQuery + Bootstrap + Html5-boilerplate + JQuery Plugins...
* 对前端技术非常执着; 会合理使用前沿的前端技术, 使团队开发更加具有效率, 极致优化产品性能. 同时提高产品的体验感,维护性,稳定性,
...
## 技术能力    
**开发工具**: MAC OSX, Terminal, ChromeDevTools, Webstorm IDE, HBuilder,  
**前端开发**: HTML5、Css、JavaScript、Json、Ajax、FireBug、
