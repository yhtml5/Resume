...
做过十来个前端项目, 有一套自己的[前端开发工作流],(前端脚手架); 能独立完成一个完整的前端项目; 
...
* 熟练使用基于NodeJs的开发构建工具,如: bower,fis3,   
...
**技术标签: NodeJs, Npm, Bower, Commanjs, Fis3, Git, Glob**
...
同时它使用FIS3解决前端工程中性能优化、资源加载（异步、同步、按需、预加载、依赖管理、合并、内嵌）、模块化开发、自动化工具、开发规范、代码部署等问题
